package com.example.share.loading.view;
...
import com.example.share.loading.ZLoadingBuilder;
import com.example.share.loading.ZLoadingDrawable;
import com.example.share.loading.Z_TYPE;
...
public class ZLoadingView extends ImageView
{
    ...
    public ZLoadingBuilder getZLoadingBuilder(){

        return mZLoadingBuilder;
    }
